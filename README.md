...
- Clearing all the balls on screen clears the stage. There are 60 stages: a world-tour of real landmarks (1-20), dimension-warp portals (21-30), an undersea current (31-40, "The Trench"), a gravity well (41-50, "Stellar Forge"), and a final arc that travels outward from the solar system through the galaxy into deep space, ending on a Hellfire finale (51-60). Clear all 60 to clear the game, with a certificate-style celebration every 10 stages.
